...
def dataset(DATA_DIR = 'data/ml-100k/preprocessed/',fold = 1):
	...
	def load_data(csv_file, shape=(n_users, n_items),binary = True):
	    ...
	    if binary:
	    	...
	    	data = sparse.csr_matrix((ratings, (rows, cols)), dtype=np.int16, shape=shape)
	    return data, seq
